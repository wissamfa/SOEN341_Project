...
//if the cange button is clicked 
    if(isset($_POST['change'])){

        // take the inforamtion from the textarea where the user wrote the new password 
        ...
        if ($pass == $pass1) {
            ...
            if (strlen($pass) >= 8 && strlen($pass) <= 60) {
                ...
                echo "<script>alert('Your Password should be greater than 8 characters')</script>";
            }

...
<?php
	...
	echo"
		...
		<a href='user_profile.php?u_id=$u_id&page=1'><<</a>
	";

    // create a link to different pages ( add numbers between the first and the last page ) 
	for ($i=1; $i <= $total_pages ; $i++) { 
		echo"<a href='user_profile.php?u_id=$u_id&page=$i'>$i</a>";
	}

    // create a link to the last page 
	echo"<a href='user_profile.php?u_id=$u_id&page=$total_pages'>>></a></div>";
?>